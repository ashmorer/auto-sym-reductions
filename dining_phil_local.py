...
def mkT1(pc,lfork,rfork,pc_p,lfork_p,rfork_p):
	return And(pc==State.T, pc_p==State.H,
                   lfork==lfork_p, rfork==rfork_p)
def mkT2(pc,lfork,rfork,pc_p,lfork_p,rfork_p):
	return And(pc==State.H, pc_p==State.H,
                   lfork==Fork.unowned, lfork_p==Fork.ccw, rfork==rfork_p)
def mkT3(pc,lfork,rfork,pc_p,lfork_p,rfork_p):
	return And(pc==State.H, pc_p==State.H,
                   rfork==Fork.unowned, rfork_p==Fork.cw, lfork==lfork_p)
def mkT4(pc,lfork,rfork,pc_p,lfork_p,rfork_p):
	return And(pc==State.H, pc_p==State.E,
                   lfork==Fork.ccw, lfork_p==Fork.ccw, rfork==Fork.cw, rfork_p==Fork.cw)
def mkT5(pc,lfork,rfork,pc_p,lfork_p,rfork_p):
	return And(pc==State.E, pc_p==State.T,
                   lfork_p==Fork.unowned, rfork_p==Fork.unowned)
def mkT(pc,lfork,rfork,pc_p,lfork_p,rfork_p):
        return Or(mkT1(pc,lfork,rfork,pc_p,lfork_p,rfork_p),
                  mkT2(pc,lfork,rfork,pc_p,lfork_p,rfork_p),
                  mkT3(pc,lfork,rfork,pc_p,lfork_p,rfork_p),
                  mkT4(pc,lfork,rfork,pc_p,lfork_p,rfork_p),
                  mkT5(pc,lfork,rfork,pc_p,lfork_p,rfork_p))
...
#Init -> Inv
cons1 = ForAll([pc, lfork, rfork],
               Implies(mkInit(pc, lfork, rfork), Inv(pc, lfork, rfork)))

vars = [pc, lfork, rfork, pc_p, lfork_p, rfork_p]
trans1Loc = ForAll(vars,
                   Implies(And(Inv(pc, lfork, rfork),
                               mkT1(pc, lfork, rfork, pc_p, lfork_p, rfork_p)),
                           Inv(pc_p, lfork_p, rfork_p)))
trans2Loc = ForAll(vars, Implies(And(Inv(pc, lfork, rfork),
                                     mkT2(pc, lfork, rfork, pc_p, lfork_p, rfork_p)),
                                 Inv(pc_p, lfork_p, rfork_p)))
trans3Loc = ForAll(vars, Implies(And(Inv(pc, lfork, rfork),
                                     mkT3(pc, lfork, rfork, pc_p, lfork_p, rfork_p)),
                                 Inv(pc_p, lfork_p, rfork_p)))
trans4Loc = ForAll(vars, Implies(And(Inv(pc, lfork, rfork),
                                     mkT4(pc, lfork, rfork, pc_p, lfork_p, rfork_p)),
                                 Inv(pc_p, lfork_p, rfork_p)))
trans5Loc = ForAll(vars, Implies(And(Inv(pc, lfork, rfork),
                                     mkT5(pc, lfork, rfork, pc_p, lfork_p, rfork_p)),
                                 Inv(pc_p, lfork_p, rfork_p)))
...
#"""
trans5Int = ForAll(vars2, Implies(And(Inv(pc, lfork, rfork),
                                      Inv(pc_int, lfork_int, rfork_int),
...
cons3 = [trans1Int, trans2Int, trans3Int, trans4Int, trans5Int]
